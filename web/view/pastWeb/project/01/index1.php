	...
	<div class="wrap">
		...
		<header class="nav-header">
			<div class="head-contain">
				...
				<nav class="top-nav">
					<ul>
						<li><a href="video.html" target="_blank">王者视频站</a></li>
                        <li><a href="javascript:alert('该链接制作中...目前已开放链接为[登录] / [注册] / [视频站]')">游戏特权</a></li>
                        <li><a href="javascript:alert('该链接制作中...目前已开放链接为[登录] / [注册] / [视频站]')">会员活动</a></li>
                        <li><a href="javascript:alert('该链接制作中...目前已开放链接为[登录] / [注册] / [视频站]')">成长体系</a></li>
                        <li><a href="javascript:alert('该链接制作中...目前已开放链接为[登录] / [注册] / [视频站]')">年费专区</a></li>
                        <li><a href="javascript:alert('该链接制作中...目前已开放链接为[登录] / [注册] / [视频站]')">超级会员</a></li>
					</ul>
				</nav>
				<span class="success">欢迎回来，尊敬的
					<a class="link" href="javascript:void(0)" style="text-decoration:none;color:deeppink;font-size:20px;"><?PHP session_start(); echo $_SESSION['user'] ?></a>
				</span>
				<div class="top-right" style="display: none;">
					<a href="login.html" class="login">登录</a>
					<a href="register.html" class="open-vip">会员注册</a>
				</div>
			</div>
		</header>
		<section class="index-wrap" id="slide">
			...
			<section class="sec1 current">
				...
				<p class="sec1-vip">
					...
					<a href="register.html" class="super-vip">注册会员</a>
				</p>
